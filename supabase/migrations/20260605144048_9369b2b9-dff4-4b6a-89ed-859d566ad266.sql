CREATE INDEX IF NOT EXISTS idx_social_interactions_top_posts_fast
  ON public.social_interactions (user_id, candidate_id, is_political_content, invalidated_at, collected_at DESC)
...
BEGIN
  ...
  WITH base AS (
    SELECT
      ...
      coalesce(si.political_relevance_score, 0) AS live_score
