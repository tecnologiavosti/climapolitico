  ...
  >
    ...
    <div className="relative flex flex-col gap-4 text-white sm:flex-row sm:items-center sm:justify-between">
      <div className="space-y-2 max-w-xl">
        <div className="inline-flex items-center gap-2 rounded-full bg-white/20 px-3 py-1 text-xs font-medium backdrop-blur-sm text-white">
      ...
      <Button
        asChild
        size="lg"
        className="shrink-0 shadow-lg hover-lift font-semibold bg-white text-slate-900 hover:bg-white/90"
      >
        <Link to="/dashboard/candidates-catalog">
          Adicionar candidato
          <ArrowRight className="ml-2 h-4 w-4 text-slate-900" aria-hidden />
        </Link>
      </Button>
    </div>
  </div>
