...
const adminGroup: NavGroup = {
  ...
  items: [
    ...
    { title: "Assinaturas", url: "/dashboard/admin/subscriptions", icon: BookUser },
    { title: "Candidatos", url: "/dashboard/admin/candidates", icon: Users },
    { title: "Sistema", url: "/dashboard/admin/system", icon: Settings },
